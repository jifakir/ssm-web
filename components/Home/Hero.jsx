                ...
                >
                    {
                        slideData.map((slide, idx) => (
                            <SwiperSlide key={`slide_${idx}`}>
                                <div className="relative w-full h-[180px] xs:h-[250px] sm:h-[300px] md:h-[400px] lg:h-[550px] overflow-hidden">
                                ...
                                <div className="absolute z-10 top-1/3 sm:top-1/2 left-5 sm:left-14 md:left-24">
                                    <h1 className="font-sterio text-3xl md:text-5xl text-primary">{slide.title}</h1>
                                    <p className="my-2 md:my-5 text-xs md:text-base">{slide.description}</p>
                                    <Button 
                                        title={'Start Saying More'} 
                                        className="text-xs md:text-xl btn-sm md:btn-md md:shadow-md btn-secondary"
                                         />
                                </div>
                            </SwiperSlide>
                        ))
