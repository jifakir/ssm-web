    ...
    return (
        <div className="">
           <div className="relative w-full">
                ...
                <div className="absolute w-full font-sterio right-1/2 translate-x-1/2 md:translate-x-0 text-4xl font-medium md:font-normal md:text-7xl text-primary z-10 top-1/2 md:right-24 transform -translate-y-1/2 text-center md:text-right leading-[50px] md:leading-[93px]">
